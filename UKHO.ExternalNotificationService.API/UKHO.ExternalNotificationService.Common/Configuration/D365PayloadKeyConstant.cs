...
namespace UKHO.ExternalNotificationService.Common.Configuration
{
    public static class D365PayloadKeyConstant
    {
        ...
        public const string NotificationTypeKey = "ukho_subscriptiontype";
        public const string SubscriptionIdKey = "ukho_subscriptiontype";
        public const string WebhookUrlKey = "ukho_webhookurl";
    }
}
